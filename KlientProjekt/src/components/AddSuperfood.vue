<template>
    <div>
    <form @submit.prevent="addSuperfood()">
        <h2>Lägg till superfood</h2>
        ...
        methods: {
            async addSuperfood() {
               ...
               if(this.productno != 0 & this.name != 0 & this.category != 0 & this.amount != 0 & this.price != 0) { 
                    ...
                    this.productno = "";
                    this.name = "";
                    this.category = "Superfood";
                    this.amount = "";
                    this.price = ""; 
                    
                    //Emit för att ladda om sidan
                    this.$emit("superfoodAdded");
                
                    document.getElementById("error2").innerHTML = "<p class='alert alert-success alert-dismissible fade show'>" + "Superfood tillagd till listan!" + "</p>";
